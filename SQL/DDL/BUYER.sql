...
ALTER TABLE [BUYER] WITH CHECK ADD CONSTRAINT [CK_BUYER_ID_NN] CHECK (Buyer_ID >= 0)
GO
ALTER TABLE [BUYER] CHECK CONSTRAINT [CK_BUYER_ID_NN]
GO 
...
GO
ALTER TABLE [BUYER] CHECK CONSTRAINT [CK_BUYER_NAME_FORMAT]
GO
